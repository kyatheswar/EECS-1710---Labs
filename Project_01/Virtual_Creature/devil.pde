class Devil {
  ...
  Devil(float x, float y) {
    ...
    face02.resize(face01.width/3, face01.height/3);
    face03 = loadImage("face03.png");
    face03.resize(face01.width/3, face01.height/3);
    face04 = loadImage("face04.png");
    face04.resize(face01.width/3, face01.height);
